...
2. 故事真实性 (authenticity): 真实故事是否保持原貌，未被替换成通用内容 [故事类数据必填]
3. 指令遵循度 (instruction_following): 输出是否紧扣主题/指令
4. 输出质量 (output_quality): 内容准确性、逻辑性、专业性
5. 微调适用性 (finetuning_suitability): 是否适合作为模型微调训练数据
